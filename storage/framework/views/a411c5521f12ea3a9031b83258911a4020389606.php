...
<script>
	window.config = {
		"API":"<?php echo e(url('api/v1')); ?>/", //URL OF YOUR API LOCATED
		"baseURL":"<?php echo e(url('')); ?>/", //URL OF YOUR WEBSITE
		"storageURL":"<?php echo e(config('app.cloudinary_enabled') ? '' : url('storage/')); ?>", //URL WHERE YOUR IMAGES and OTHER FILEs stored
